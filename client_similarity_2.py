...
if __name__ == "__main__":
    ...
    parser.add_argument("--w_rhythm", type=float, default=0.35, help="Weight for rhythm features (default: 1/3).")
    parser.add_argument("--w_tonal", type=float, default=0.35, help="Weight for tonal features (default: 1/3).")
    # ------------------------------------------------------
